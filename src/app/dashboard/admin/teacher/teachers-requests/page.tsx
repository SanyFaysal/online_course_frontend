...
export default function TeacherRequests() {
    ...
    const teachers = filterTeacher(data, true)
        ...
        },
        {
            ...
            render: (_, record) => (
                <Space size="middle" className='flex justify-center'>
                    <button className='cursor-pointer bg-blue-100 text-blue-500 px-2 py-[1px] rounded text-sm'>Details</button>
                    <button onClick={() => handleApproveTeacher(record?.id)} className='cursor-pointer bg-green-100 text-green-500 px-2 py-[1px] rounded text-sm'>Approve</button>
