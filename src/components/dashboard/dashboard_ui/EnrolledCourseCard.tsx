    ...
    return (
        <div className="bg-gray-100 rounded-lg  ">
            ...
            <div className="px-3 py-2 mt-[-25px] z-[999]">
                <h1 className="text-sm font-semibold  ">Course Code : {course?.course}</h1>
                <h1 className="text-sm font-semibold mb-3"> Enrolled at : {course?.date}</h1>
                <div className="flex justify-end">
                    <button className="bg-purple-200 text-purple-500  duration-300 px-2  rounded-full">{course?.status}</button>
                </div>
            </div>
        </div>
    )
